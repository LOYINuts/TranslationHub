...
with open('FDEJenassa/FDE Jenassa Part 2_20F57570.xml', 'r', encoding='utf-8-sig') as f:
    content = f.read()
...
with open('FDEJenassa/FDE Jenassa Part 2_20F57570.xml', 'w', encoding='utf-8-sig') as f:
    f.write(content)
